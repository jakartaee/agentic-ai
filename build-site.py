...
To preview a change locally, fetch the same page the workflow does and build
against it:

    curl -s -L https://jakarta.ee/specifications/agentic-ai/1.0/ -o /tmp/shell.html
    python3 build-site.py /tmp/shell.html index.html content.html
