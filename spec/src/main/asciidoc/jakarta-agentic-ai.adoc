...
- **Sequential Phases**: Trigger, decision, action, and outcome phases execute in order
...
- **Application Scope**: `@ApplicationScoped` agents should take thread-safe into account as they may handle multiple workflow invocations
