...
- Implementations may reject unsupported type conversions with `IllegalArgumentException`.
- Invalid or unserializable inputs MUST surface as `IllegalArgumentException`.
