...
**Jakarta Validation**: Trigger method parameters can declare Jakarta Validation constraints 
(e.g., `@Valid`, `@NotNull`, `@Email`). Validation occurs before the trigger method is invoked. 
...
**Jakarta Validation**: Decision method parameters can declare Jakarta Validation constraints. 
Validation occurs before the decision method is invoked. Validation failures raise `ConstraintViolationException`.
...
**Jakarta Validation**: Action method parameters can declare Jakarta Validation constraints. 
Validation occurs before the action method is invoked. Validation failures raise `ConstraintViolationException`.
...
**Jakarta Validation**: Outcome method parameters can declare Jakarta Validation constraints. 
Validation occurs before the outcome method is invoked. Validation failures raise `ConstraintViolationException`.
...
**Jakarta Validation**: Exception handler parameters can declare Jakarta Validation constraints. 
However, validation failures are typically not appropriate for exception handlers; if validation fails, 
the exception is propagated to the container.
