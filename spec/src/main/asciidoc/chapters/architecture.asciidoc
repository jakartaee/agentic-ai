...
The workflow model in Jakarta Agentic AI is declarative and dynamic. Rather
than explicitly programming control flow, developers annotate methods to mark
their role in the workflow, and the runtime orchestrates execution.
